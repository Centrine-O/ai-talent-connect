    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-primary">AI Workforce</div>
      ...
      <footer className="bg-primary text-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">AI Workforce</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/80">
                <li>Email: contact@aiworkforce.com</li>
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center text-white/70">
            <p>&copy; 2024 AI Workforce & Training. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
